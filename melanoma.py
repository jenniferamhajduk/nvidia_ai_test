...
try:
    ...
    subprocess.run(
        ["curl", "-L", "-o", "./data/melanoma-cancer-dataset.zip", 
...
zip_file_path = "./data/melanoma-cancer-dataset.zip"
extract_to_path = "./data/melanoma-cancer-dataset"
...
IMAGE_PATH = "./data/melanoma-cancer-dataset"
